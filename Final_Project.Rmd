...
We begin with a 70/30 split of the training set to produce a training and testing set. We the verify that the relative proportion of each class is the same between data sets. 
```{r}
library(caret)
